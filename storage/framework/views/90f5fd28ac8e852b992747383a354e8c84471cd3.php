            ...
            <div class="card-body">
                <form action="<?php echo e(route('admin.settings.update')); ?>" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <label class="col-form-label col-lg-2"><?php echo e(__('Upgrade_fee')); ?> <span class="text-danger">*</span></label>
                        <div class="col-lg-4">
                            <div class="input-group">
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/kingsmen/core/resources/views/admin/settings/index.blade.php ENDPATH**/ ?>