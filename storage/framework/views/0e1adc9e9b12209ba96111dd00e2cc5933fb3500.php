          ...
          <div class="card bg-secondary border-0 mb-0">
            ...
            <div class="card-body px-lg-5 py-lg-5">
              <div class="text-center text-dark mb-5">
                <small><?php echo e(__('Still cant Remember')); ?></small>
              </div>
              <form role="form" action="<?php echo e(route('user.password.email')); ?>" method="post">
                ...
                <div class="text-center">
                  <button type="submit" class="btn btn-neutral  text-dark my-4" ><?php echo e(__('Reset')); ?></button>
                </div>
              </form>
            </div>
          </div>
...
<?php echo $__env->make('loginlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/kingsmen/core/resources/views/auth/passwords/email.blade.php ENDPATH**/ ?>