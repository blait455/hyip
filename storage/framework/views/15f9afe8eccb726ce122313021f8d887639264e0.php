            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="backg-content">
                        ...
                        <span class="backg-title wow soneFadeUp" data-wow-delay="0.5s"><?php echo e(__('Privacy Policy')); ?></span>
                    </div>
                </div>
            </div>
        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/kingsmen/core/resources/views/front/privacy.blade.php ENDPATH**/ ?>