            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header header-elements-inline">
                        <h6 class="card-title font-weight-semibold"><?php echo e(__('Pending deposit')); ?></h6>
                    </div>
                    <div class="">
                                    ...
                                    <td class="text-center">
                                        <div class="list-icons">
                                            <div class="dropdown">
                                                ...
                                                <?php if($val->status==0): ?>
                                                    <a class='dropdown-item' href="<?php echo e(url('/')); ?>/admin/approvedeposit/<?php echo e($val->id); ?>"><i class="icon-thumbs-up3 mr-2"></i><?php echo e(__('Approve')); ?></a>
                                                    <a class='dropdown-item' href="<?php echo e(url('/')); ?>/admin/declinedeposit/<?php echo e($val->id); ?>"><i class="icon-thumbs-down3 mr-2"></i><?php echo e(__('Decline')); ?></a>
                                                <?php endif; ?>
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/kingsmen/core/resources/views/admin/deposit/pending.blade.php ENDPATH**/ ?>