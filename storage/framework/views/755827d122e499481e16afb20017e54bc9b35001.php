          ...
          <?php echo csrf_field(); ?>
           <div class="form-group row">
            ...
            <div class="form-group row">
              ...
              <div class="col-lg-9">
                <div class="custom-file">
                  ...
                  <label class="custom-file-label" for="customFileLang" style="border-color: <?php echo e($set->s_c); ?>;"><?php echo e(__('Choose Screenshot')); ?></label>
                </div>
              </div>
            </div> 
            <div class="row">
            ...
            <div class="text-right">
                <button type="submit" class="btn btn-success btn-sm"><?php echo e(__('Proceed')); ?></button>
            </div>
                </div>
              </div>
            </div>
            ...
            <div class="">
              <div>
                ...
                <ul class="list list-unstyled mb-0 card-text text-sm text-dark">
                  <li><?php echo e(__('Name')); ?>: <?php echo e($bank->name); ?></li>
                  <li><?php echo e(__('Bank')); ?>: <?php echo e($bank->bank_name); ?></li>
                  <li><?php echo e(__('Address')); ?>: <?php echo e($bank->address); ?></li>
                  <li><?php echo e(__('Swift Code')); ?>: <?php echo e($bank->swift); ?></li>
                  <li><?php echo e(__('Iban Code')); ?>: <?php echo e($bank->iban); ?></li>
                  <li><?php echo e(__('Account Number')); ?>: <?php echo e($bank->acct_no); ?></li>
                </ul>
              </div>
            </div>
          </div>
...
<?php echo $__env->make('userlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/kingsmen/core/resources/views/user/fund/bank.blade.php ENDPATH**/ ?>