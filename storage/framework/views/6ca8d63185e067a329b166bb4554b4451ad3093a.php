                    ...
                    <div class="card-body">
                        ...
                        <?php echo csrf_field(); ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" name="description" class="form-control" value="<?php echo e($plan->description); ?>">
                                </div>
                            </div> 
                            <div class="form-group row">
                                <label class="col-form-label col-lg-2"><?php echo e(__('Category')); ?></label>
                                <div class="col-lg-10">
                                    <input type="text" name="category" class="form-control" value="<?php echo e($plan->category); ?>" reqiured>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-form-label col-lg-2"><?php echo e(__('Sub-category')); ?></label>
                                <div class="col-lg-10">
                                    <input type="text" name="sub_cat" class="form-control" value="<?php echo e($plan->sub_cat); ?>">
                                </div>
                            </div> 
                            <div class="form-group row">
                                <label class="col-form-label col-lg-2"><?php echo e(__('Weekly percent')); ?></label>
                                <div class="col-lg-10">
                            ...
                            <div class="form-group row">
                                <label class="col-form-label col-lg-2"><?php echo e(__('Trading(Compoundment) Bonus')); ?></label>
                                <div class="col-lg-10">
                                    <div class="input-group">
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/toor/Documents/core/resources/views/admin/investment/edit.blade.php ENDPATH**/ ?>