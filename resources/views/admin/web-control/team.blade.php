                                        ...
                                        <div class="text-right">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                    ...
                                                    @if($val->status==1)
                                                        <a class='dropdown-item' href="{{route('team.unpublish', ['id' => $val->id])}}">{{__('Unpublish')}}</a>
                                                    @else
                                                        <a class='dropdown-item' href="{{route('team.publish', ['id' => $val->id])}}">{{__('Publish')}}</a>
                                                    @endif
                                                    <a href="{{route('team.edit', ['id' => $val->id])}}" class="dropdown-item">{{__('Edit')}}</a>
                                                </div>
                                            </div>
                                        </div> 
                                    </td>                   
                                            ...
                                            <div class="modal-body p-0">
                                                <div class="card bg-white border-0 mb-0">
                                                    ...
                                                    <div class="card-body px-lg-5 py-lg-5 text-right">
                                                        ...
                                                        <a  href="{{route('team.delete', ['id' => $val->id])}}" class="btn btn-danger btn-sm">{{__('Proceed')}}</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
