            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header header-elements-inline">
                        <h6 class="card-title font-weight-semibold"><?php echo e(__('Create')); ?></h6>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <select class="form-control select" name="period" data-fouc required>                                           
                                        ...
                                        <option value="Week"><?php echo e(__('Week')); ?></option>                
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/kingsmen/core/resources/views/admin/py-scheme/create.blade.php ENDPATH**/ ?>